package com.s2m.ludwig.persister.cooccur.lsh;
...
public class LSHSink {
	...
	public LSHSink() throws IOException {
	 ...
	 * @throws IOException
	 */
	public void createSumArrayPut(long term, float[] sumArray) throws IOException {
		...
		buffer.flip();
		byte[] rowkey = Bytes.toBytes(term);
	 ...
	 * @throws IOException
	 */
	public void flushSumArrays() throws IOException {
	...
	/**
	 * 
	 * Create the Get to retrieve the sumArray associated to the given term.
	 * 
	 * @param long term
	 */
	public void createSumArrayGet(long term) {
		// TODO: Manage the case in which there is no sumArray for the given term
		//       Maybe null is already enough?
