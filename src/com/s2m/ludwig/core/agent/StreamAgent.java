...
public  abstract class StreamAgent extends Thread {
	 ...
	 *
	 *	// create NUMBER_OF_AGENTS partitions of the stream for topic, to allow NUMBER_OF_THREADS_PER_AGENT threads to consume
	 *	Map<String, List<KafkaMessageStream>> TPMessageStreams = 
	 *		consumer.createMessageStreams(ImmutableMap.of(topic, NUMBER_OF_AGENTS));
	 *
	 ...
	 *	ExecutorService executors = Executors.newFixedThreadPool(NUMBER_OF_THREADS_PER_AGENT);
	 *
