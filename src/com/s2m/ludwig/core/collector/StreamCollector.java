...
public abstract class StreamCollector extends Thread {
	...
	public StreamCollector(int NUMBER_OF_SAME_COLLECTORS, int NUMBER_OF_DIFFERENT_COLLECTORS, int NUMBER_OF_THREADS_PER_COLLECTOR) {
	 ...
	 *  
	 *  String topic = "The name of your topic"
	 * 
	 * 
	 *  // TODO: comment here + maybe change the way to access to conf
	 *	Map<String, List<KafkaMessageStream>> MessageStreams = 
	 *		consumer.createMessageStreams(ImmutableMap.of(topic, NUMBER_OF_SAME_COLLECTORS));
	 *	List<KafkaMessageStream> streams = MessageStreams.get(topic);
     *
	 *	// TODO: comment here + maybe change the way to access to conf
	 *	ExecutorService executors = Executors.newFixedThreadPool(NUMBER_OF_THREADS_PER_COLLECTOR);
     *
