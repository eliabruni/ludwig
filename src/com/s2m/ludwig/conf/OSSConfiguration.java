 ...
 */
public class OSSConfiguration extends Configuration {
	protected static final Logger LOG = LoggerFactory
	.getLogger(OSSConfiguration.class);
	private static OSSConfiguration singleton;
	...
	public synchronized static OSSConfiguration get() {
		if (singleton == null)
			singleton = new OSSConfiguration();
		return singleton;
	}

	protected OSSConfiguration() {
		this(true);
	}


	protected OSSConfiguration(boolean loadDefaults) {
		super();
		if (loadDefaults) {
